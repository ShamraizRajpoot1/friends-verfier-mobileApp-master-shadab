        ...
        {isTab1Active ? (
          <View style={{ marginTop: RFValue(-5), padding: RFValue(25) }}>
            <Text style={styles.faqsText}>
              ...
              register with Friend Verifier.com. For example, you may be
              required to register if you want to set up a Site account, where
              you can save your preferences, receive email alerts, discount
              offerings, utilize free and paid searches, or other information
              from the Site. You may also be required to register to receive
              email updates with updated information from Friend Verifier.com.
              The use of any personal information that you provide to Friend
              Verifier during any registration process is governed by our
              privacy policy. Users may receive email confirming their
              registration Friend Verifier.com, as well as promotional marketing
              of commercial products and services. By having an account with
              Friend Verifier, you agree to take full responsibility for
              ...
              user name.{"\n"}
              {"\n"}2. Your Registration Obligations In consideration of your
              use of the Site's services, you represent that you are of legal
              age to form a binding contract and are not a person barred from
              receiving our services under the laws of the United States or
              other applicable jurisdiction. You also agree to: (i) provide
              ...
              the site and by using this site you agree to pay those fees for
              said services. Unless we indicate otherwise, all fees and charges
              are final, with no refunds. There are no refunds for the purchase
              of credits nor are there refunds for the purchasing of services on
              ...
              {"\n"}
              {"\n"}6. Violation of the Terms You agree that monetary damages
              may not provide a sufficient remedy to the Friend Verifier for
              ...
              Friend Verifier owns all legal right, title, and interest in and
              to the Site, including any intellectual property rights which
              subsist in the Site (whether those rights happen to be registered
              or not, and wherever in the world those rights may exist). Unless
              you have agreed otherwise in writing with the Friend Verifier,
              nothing in the Terms gives you a right to use any of the Friend
              Verifier trade names, trademarks, service marks, logos, domain
              names, and other distinctive brand features.{"\n"}
              {"\n"}8. Disclaimers The information accessed on the Friend
              Verifier website are in-house databases which have been compiled
              from public records and other proprietary sources for the specific
              ...
              {"\n"}
              {"\n"}9. Communications When you visit the Site or send an emails
              to us, you are communicating with us electronically. You consent
              to receive communications from us electronically. We will
              communicate with you by an email or by posting notices on the
              ...
              {"\n"}
              {"\n"}10. LIMITATION ON LIABILITY EXCEPT IN JURISDICTIONS WHERE
              SUCH PROVISIONS ARE RESTRICTED, IN NO EVENT WILL WE BE LIABLE TO
              YOU FOR ANY INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL,
              SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFITS, EVEN IF WE
          ...
          <View style={{ marginTop: RFValue(-5), padding: RFValue(25) }}>
            <Text style={styles.faqsText}>
              ...
              property of Friend Verifier, LLC. (“Friend Verifier," "we," "our,"
              ...
              Opt-Out FAQ{"\n"}
              {"\n"}Information Collected by Friend Verifier Friend Verifier is
              a database of publicly available sources of information aggregated
              ...
              including, but not limited to, when you submit an online
              application to become a Friend Verifier member ("Member"), which
              enables you to utilize a host of services made available to
              Members by and through the Site ("Member Services");when you
              submit a request to opt out of Friend Verifier’s People Search
              results; when you conduct a Friend Verifier Check; or when you
              contact us with a question, comment, or request. This can include,
              but is not limited to, your: (a) email address; (b) full name; (c)
              company name; (d) date of birth; (e) password; (f) mailing
              address; (g) credit card information; and (h) information
              associated with a Search Subject (such as a name, age, or address)
              that you use to conduct a Friend Verifier Check. Information
              Collected Automatically About Your Usage As is true of most web
              sites, we gather certain information automatically and store it in
              log files. This information may include internet protocol (IP)
